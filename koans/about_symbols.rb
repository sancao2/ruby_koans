...
class AboutSymbols < Neo::Koan
  ...
  def test_method_names_become_symbols
    ...
    assert_equal true, symbols_as_strings.is_a?(Array)
    assert_equal true, Symbol.all_symbols.include?(:test_method_names_become_symbols_didnt_exsit)
  end
  ...
  # http://stackoverflow.com/questions/13295776/ruby-koans-75-test-constants-become-symbols-correct-answer
  ...
  def test_to_s_is_called_on_interpolated_symbols
    ...
    string2 = "It is raining #{symbol.to_s} and dogs."
